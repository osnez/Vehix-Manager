...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    const vehicleFolder = `uploads/assurance/${req.params.id}`;
...
exports.showAllDocs = (req, res) => {
  ...
  fs.readdir(vehicleFolder, (err, files) => {
    ...
    res.render("admin views/assurance/assurance", {
      files: files,
...
exports.delete = (req, res) => {
  const filePath =
    "uploads/assurance/" + req.params.vehicleId + "/" + req.params.filename;
